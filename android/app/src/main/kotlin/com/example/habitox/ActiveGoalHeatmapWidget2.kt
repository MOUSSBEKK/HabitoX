...
class ActiveGoalHeatmapWidget2 : GlanceAppWidget() {
    ...
    private fun GlanceContent(context: Context, currentState: HomeWidgetGlanceState) {
        ...
        val heatmapImagePath = prefs.getString("heatmap_image_large", null)
        val iconImagePath = prefs.getString("icon_image_large", null)
